...
(function () {
  ...
  .directive('vcmsToolbar', () => ({
    ...
    link(scope, elem, attrs, vcms) {
      ...
      scope.toggleCustomElementPop = function() {
        scope.showConfig.showCustomElementPop = !scope.showConfig.showCustomElementPop;
      };

      scope.toggleStylePresetsPop = function() {
        scope.showConfig.showStylePresetsPop = !scope.showConfig.showStylePresetsPop;
      }
    },
  }))
